...
import './NewAdd.css';
import {uploadFile} from '../util/APIRe';
...
class NewAdd extends Component {
    ...
    uploadNewWebtoon() {
        try {
            uploadFile(this.state.title, this.state.artist, this.state.day, this.state.genre, this.state.fileList)
         ...
         return (
            <div className="newAdd-container">
                ...
                <Form onSubmit={this.uploadNewWebtoon}>
                    ...
                    <Form.Item label="썸네일">
                        <Dragger name="fileList" onChange={this.onChange} beforeUpload={() => false} >
